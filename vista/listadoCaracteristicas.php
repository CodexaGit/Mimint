...
<body>
    ...
    <section>
        ...
        <div class="contenedorCRUD">
            ...
            $Caracteristicas = $CaracteristicasController->listarCaracteristicas();
            ...
            echo "<table width='500'><tr><th class='izq'>sala</th><th>caracteristica</th><th class='ocultar'>modificar</th><th class='ocultar'>eliminar</th></tr>";
            $numero = "uno";
            ...
            if (isset($_POST['accion']) && $_POST['accion'] == 'mostrarFormularioModificar') {
                ...
                <form action="" class="formulario" method="POST">
                    ...
                    <input type="text" name="caracteristica" placeholder="Caracteristica" required>
